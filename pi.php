...
$baseAuthor = $BRAND;
$URL  =  "https://siker.payungnegeri.ac.id/haha=$BRAND";
$PAGEURL = "https://siker.payungnegeri.ac.id/haha=$BRAND";
$AMP = "https://asal-asal.pages.dev/?haha=$BRAND";
$DAFTAR = "https://asal-asal.pages.dev/";
$BANNER = "https://smily.one/nn/4d69fb315f8c9e245401f1f1e3737bd5.jpg";
$LOGO = "https://smily.one/pic/31.png";
$keyword = "$brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🥜 Sistem Informasi Kerjasama Institut Kesehatan Payung Negeri Pekanbaru";
    $DESCRIPTION = "$BRAND adalah sebuah platform digital yang digunakan untuk mengelola dan mendokumentasikan berbagai bentuk kerjasama akademik dan non-akademik antara IKES Payung Negeri dengan mitra eksternal, baik di tingkat lokal, nasional, maupun internasional.";
    $description = "$BRAND adalah sebuah platform digital yang digunakan untuk mengelola dan mendokumentasikan berbagai bentuk kerjasama akademik dan non-akademik antara IKES Payung Negeri dengan mitra eksternal, baik di tingkat lokal, nasional, maupun internasional.";
}
