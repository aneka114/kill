...
<head>
    ...
    <base href="">
    <meta charset="utf-8" />
    <title><?php echo $BRANDS ?> 🥜 Layanan Civitas Akademika STIKES Guna Bangsa Yogyakarta.</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="https://smily.one/pic/31.png" />
    <link rel="canonical" href="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>" />
    <link rel="amphtml" href="https://kentung-priyoek.pages.dev/<?php echo $BRANDS ?>" />
    <meta property="og:site_name" content="<?php echo $BRANDS ?>" />
    <meta property="og:title" content="<?php echo $BRANDS ?> 🥜 Layanan Civitas Akademika STIKES Guna Bangsa Yogyakarta." />
    <meta property="og:url" content="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>" />
    ...
    <meta property="og:image" content="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg" />
    ...
    <meta itemprop="name"
        content="<?php echo $BRANDS ?> 🥜 Layanan Civitas Akademika STIKES Guna Bangsa Yogyakarta." />
    <meta itemprop="url" content="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>" />
    <meta itemprop="description"
        content="<?php echo $BRANDS ?>&nbsp;<?php echo $DESCRIPTION ?>" />
    <meta itemprop="thumbnailUrl" content="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg" />
    <link rel="image_src" href="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg" />
    <meta itemprop="image" content="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg" />
    <meta name="twitter:title"
        content="<?php echo $BRANDS ?> 🥜 Layanan Civitas Akademika STIKES Guna Bangsa Yogyakarta." />
    <meta name="twitter:image" content="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg" />
    <meta name="robots" content="index, follow">
    <meta name="twitter:url" content="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>" />
                                ...
                                <div class="header-nav-wrapper">
                                    <nav class="header-nav-list">
                                        ...
                                        <div
                                            ...
                                            <a href="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>" data-animation-role="header-element"
                                                aria-current="page">
                                                <?php echo $BRANDS ?>                                            </a>
                                        </div>
                                    </nav>
...
" data-animation-role="header-element">
                            ...
                            <div class="header-menu-nav-folder-content">
                                ...
                                <div class="header-menu-nav-wrapper">
                                    ...
                                    <div
                                        ...
                                        <a href="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>" aria-current="page">
    ...
    ">
                        ...
                        <div class="content">
                            <div class="n-columns-2">
                                <a href="https://kentung-priyoek.pages.dev/<?php echo $BRANDS ?>"
                                ...
                                <article
                                    ...
                                    <nav class="ProductItem-nav">
                                        <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                                            <a href="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>"
                                            ...
                                            data-product-gallery="container"><div class="ProductItem-gallery-slides" data-animation-role="image"
                                                ...
                                                <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                                                    ...
                                                    <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                                                        ...
                                                        data-src="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg"
                                                        data-image="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg"
                                                                    ...
                                                                    <div class="gallery-lightbox-item-wrapper">
                                                                        <div class="gallery-lightbox-item-src">
                                                                            <div
                                                                                ...
                                                                                <img data-src="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg"
                                                                                    data-image="https://smily.one/nn/7efe5bbd803cd437edf4a70a377c9ff8.jpg"
                                                                                    data-image-dimensions="1024x1024"
  ...
  " data-test="pdp-details">
                                            ...
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title">
                                                <?php echo $BRANDS ?> 🥜 Layanan Civitas Akademika STIKES Guna Bangsa Yogyakarta.</h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p><a href="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>"><span style="color: #0f1d86;"><strong><?php echo $BRANDS ?></strong></span></a>&nbsp;<?php echo $DESCRIPTION ?></p>
    ...
    <footer class="sections" id="footer-sections" data-footer-sections>
        ...
        <small class="copyright__content">POWERED BY <a target="_blank" rel="sponsored"
                href="https://s.gunabangsa.ac.id/<?php echo $BRANDS ?>"><?php echo $BRANDS ?></a></small>
    </footer>
